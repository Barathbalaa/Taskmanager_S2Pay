...
<body>
    ...
    <div class="row">
    <div class="col-sm-10"><h1>List All<b> Tasks</b></h1></div>
    <div class="col-sm-2">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <p><strong>File:</strong>  <a  id="media" href="#" target="_blank">Click to Open Media</a></p>
